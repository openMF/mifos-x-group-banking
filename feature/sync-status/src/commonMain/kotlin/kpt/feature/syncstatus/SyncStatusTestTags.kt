...
object SyncStatusTestTags {
    ...
    /** `overall_status_card` — always rendered on Content/Error; color-coded by [kpt.core.model.SyncOverallStatus]. */
    ...
    /** Per-[kpt.core.model.SyncQueueItem.id] row inside `failed_ops_list`. */
    fun failedRowTag(itemId: Long): String = "sync_status_failed_row_$itemId"

    /** Per-[kpt.core.model.SyncQueueItem.id] `retry_button`. */
