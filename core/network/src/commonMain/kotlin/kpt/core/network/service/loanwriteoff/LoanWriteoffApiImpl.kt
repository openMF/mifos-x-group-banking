 ...
 */
package kpt.core.network.service.loanwriteoff
 ...
 * [kpt.core.data.repository.LoanWriteoffRepositoryImpl]). The HTTP-status ->
 * [NetworkError] mapping mirrors `core-base/network`'s `ResultSuspendConverterFactory` table
 * exactly, same as
 * [kpt.core.network.service.loanrepayment.LoanRepaymentApiImpl] /
 * [kpt.core.network.service.loandetail.LoanDetailApiImpl].
 *
