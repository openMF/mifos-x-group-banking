...
interface LoanApi {
     ...
     * the loan-list contract's flat [kpt.core.network.model.LoanSummaryDto] row
     ...
     * [kpt.core.network.model.LoanSummaryDto]): `idea-layer/screens/personal-loans/api.yaml#api[get_self_loans]`
     ...
     * (flat `LoanSummaryDto`, [kpt.core.network.mapper.toDomainModels]) per an
