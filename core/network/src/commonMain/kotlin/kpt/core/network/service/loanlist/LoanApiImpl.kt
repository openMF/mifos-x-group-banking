 ...
 */
package kpt.core.network.service.loanlist
 ...
 * [kpt.core.network.service.memberlist.MemberApiImpl] and
 * [kpt.core.network.service.grouplist.GroupApiImpl].
 *
 ...
 * [LoanApi.getGroupLoans].
 *
 * See API.md#services — LoanApi.
 */
class LoanApiImpl(
    ...
    override suspend fun getGroupLoans(
        ...
        val path = "$GROUPS_PATH/$groupId/loans"
        Logger.d(TAG) {
            "getGroupLoans: GET $path (limit=$limit, offset=$offset, loanStatus=$loanStatus)"
        }
        return requestAsNetworkResult(op = "getGroupLoans") {
            httpClient.get(path) {
