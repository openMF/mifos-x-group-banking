 ...
 * [kpt.core.data.repository.MemberAddRepositoryImpl]). The HTTP-status ->
 * [NetworkError] mapping mirrors `core-base/network`'s `ResultSuspendConverterFactory` table
 * exactly, same as
 * [kpt.core.network.service.groupcreate.GroupCreateApiImpl] /
 ...
 * [kpt.core.network.service.groupcreate.GroupCreateApiImpl.getOffices].
 *
