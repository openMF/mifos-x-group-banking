 ...
 * [org.mifos.groupbanking.core.data.repository.LoanRepaymentRepositoryImpl] switches on the
...
interface LoanRepaymentApi {
     ...
     * bucket — same convention as [org.mifos.groupbanking.core.network.service.groupcreate.GroupCreateApi]);
