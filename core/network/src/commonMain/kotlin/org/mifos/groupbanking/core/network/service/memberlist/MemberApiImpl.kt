...
/**
 * Plain-Ktor implementation of [MemberApi]. This class is the ONLY layer in the member-list
 ...
 * [MemberApi.getGroupMembers].
 *
 * See API.md#services — MemberApi.
 */
class MemberApiImpl(
    ...
    override suspend fun getGroupMembers(
        ...
        val path = "$GROUPS_PATH/$groupId/clients"
        Logger.d(TAG) { "getGroupMembers: GET $path (limit=$limit, offset=$offset)" }
