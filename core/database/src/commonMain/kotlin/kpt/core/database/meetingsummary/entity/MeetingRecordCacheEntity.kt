 ...
 */
package kpt.core.database.meetingsummary.entity
 ...
 * store ([kpt.core.store.meetingsummary.impl.provideMeetingSummaryStore]): one
 ...
 * [kpt.core.database.meetingsummary.entity.MeetingRecordCacheCodec]. A single-row
