 ...
 */
package kpt.core.database.memberlist.entity
 ...
 * store ([kpt.core.store.memberlist.impl.provideMembersPagingStore]) so a cold
 ...
 * ([kpt.core.database.memberlist.dao.MemberListDao.deleteOlderThan]); freshness
