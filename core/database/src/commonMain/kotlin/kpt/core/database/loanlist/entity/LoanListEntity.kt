 ...
 */
package kpt.core.database.loanlist.entity
 ...
 * store ([kpt.core.store.loanlist.impl.provideLoansPagingStore]) so a cold
 ...
 * ([kpt.core.database.loanlist.dao.LoanListDao.deleteOlderThan]); freshness
