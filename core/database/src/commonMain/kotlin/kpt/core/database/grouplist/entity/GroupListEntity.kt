 ...
 */
package kpt.core.database.grouplist.entity
 ...
 * store ([kpt.core.store.grouplist.impl.provideGroupsPagingStore]) so a cold
 ...
 * ([kpt.core.database.grouplist.dao.GroupListDao.deleteOlderThan]); freshness
