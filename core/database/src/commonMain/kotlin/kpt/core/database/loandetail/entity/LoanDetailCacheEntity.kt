 ...
 */
package kpt.core.database.loandetail.entity
 ...
 * ([kpt.core.store.loandetail.impl.provideLoanDetailStore]), a **single-key**
 ...
 * [kpt.core.database.loandetail.entity.LoanDetailCacheCodec]. A single-row upsert
