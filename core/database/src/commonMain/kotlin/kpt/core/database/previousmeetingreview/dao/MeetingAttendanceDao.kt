 ...
 */
package kpt.core.database.previousmeetingreview.dao
...
import kpt.core.database.previousmeetingreview.entity.MeetingAttendanceCacheEntity

/**
 * Room DAO for the meeting-attendance cache (SourceOfTruth for the single-key NETWORK_WITH_CACHE
 * [kpt.core.store.previousmeetingreview.impl.provideMeetingAttendanceStore]).
 *
